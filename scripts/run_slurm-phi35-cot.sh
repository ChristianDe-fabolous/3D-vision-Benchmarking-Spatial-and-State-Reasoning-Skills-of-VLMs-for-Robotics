#!/bin/bash
# Phi-3.5-Vision with CoT (3.8B BF16 ~8GB) — gb10 (128GB), batch_size=64
#SBATCH --job-name=phi35-cot
...
[ "${CLEAN_CACHE:-1}" = "1" ] && rm -rf "$HF_HOME/hub/models--microsoft--Phi-3.5-vision-instruct"

#!/bin/bash
# Qwen3-VL-30B on multiview consistency dataset (30B MoE BF16 ~60GB, 3B active) — gb10 (128GB), batch_size=2
#SBATCH --job-name=qwen3-30b-multiview
...
[ "${CLEAN_CACHE:-1}" = "1" ] && rm -rf "$HF_HOME/hub/models--Qwen--Qwen3-VL-30B-A3B-Instruct"

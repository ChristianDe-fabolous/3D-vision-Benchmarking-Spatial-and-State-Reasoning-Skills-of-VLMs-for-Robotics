#!/bin/bash
# Gemma4-E4B with CoT on multiview consistency dataset (8B BF16 ~16GB) — gb10 (128GB), batch_size=8
#SBATCH --job-name=gemma4-e4b-multiview-cot
...
[ "${CLEAN_CACHE:-1}" = "1" ] && rm -rf "$HF_HOME/hub/models--google--gemma-4-E4B-it"

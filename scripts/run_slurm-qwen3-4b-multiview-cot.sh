#!/bin/bash
# Qwen3-VL-4B with CoT on multiview consistency dataset (4B BF16 ~8GB) — gb10 (128GB), batch_size=32
#SBATCH --job-name=qwen3-4b-multiview-cot
...
[ "${CLEAN_CACHE:-1}" = "1" ] && rm -rf "$HF_HOME/hub/models--Qwen--Qwen3-VL-4B-Thinking"

#!/bin/bash
# Qwen3-VL-30B-Thinking with CoT on multiview consistency dataset (30B MoE BF16 ~60GB) — gb10 (128GB), batch_size=8
#SBATCH --job-name=qwen3-30b-multiview-cot
...
[ "${CLEAN_CACHE:-1}" = "1" ] && rm -rf "$HF_HOME/hub/models--Qwen--Qwen3-VL-30B-A3B-Thinking"

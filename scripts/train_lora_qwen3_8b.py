#!/usr/bin/env python3
"""LoRA fine-tune Qwen/Qwen3-VL-8B-Instruct on action_phase_dataset.
...
Usage:
    python scripts/train_lora_qwen3_8b.py
    python scripts/train_lora_qwen3_8b.py --n-train-scenes 8 --seed 42 --output-dir outputs/lora-run1
"""
...
# Conv3d (vision patch_embed) hits CUDNN_STATUS_SUBLIBRARY_VERSION_MISMATCH on the
# aarch64/.venv-arm64 stack; cudnn convs are a tiny share of compute, so disable.
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="outputs/lora-qwen3-vl-8b")

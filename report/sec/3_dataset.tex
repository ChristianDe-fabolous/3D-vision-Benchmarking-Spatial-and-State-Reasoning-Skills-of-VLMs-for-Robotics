...
For failure detection, we prompt the model with all 3 views merged into a single image, as provided by \cite{chen2025robo2vlm}. CoT shows the models can identify the individual views in a merged image.
